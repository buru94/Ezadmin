...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun setupChat() {
        ...
        LoadSelections()
Log.e(TAG, StrMACAdress.toString())
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                ...
                MESSAGE_BARCODE -> {
                    ...
                    if (Barcode.length != 0) {
                        MAIN_ACTIVITY_BARCODE_SCAN_TEXT_VIEW.text = Barcode
                    }
    ...
    override fun onDestroy() {
        // TODO Auto-generated method stub
        super.onDestroy()
        Log.d(TAG, StrMACAdress.toString())
        if (mChatService != null) {
            if (StrMACAdress != null) {
                SaveSelections()
            }
    ...
    companion object {
        ...
        @JvmField
        internal var mChatService: BluetoothChatService? = null
