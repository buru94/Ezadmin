...
import kotlinx.android.synthetic.main.activity_product_loc_reserve.*

class Product_LOC_Activity : AppCompatActivity() {
        ...
        override fun handleMessage(msg: Message) {
            when (msg.what) {
                ...
                StockManageFragment.MESSAGE_BARCODE -> {
                    ...
                    if (Barcode.length != 0) {
                        PRODUCT_LOC_RESERVE_ACTIVITY_BARCODE_EDITTEXT.setText(Barcode)
                    }
                }
            }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_product_loc_reserve)
